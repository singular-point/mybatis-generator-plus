...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectAllElementWithSelectiveGenerator;
...
//        AbstractXmlElementGenerator elementGenerator = new SimpleSelectAllElementGenerator();//参数不可用
    	AbstractXmlElementGenerator elementGenerator = new SelectAllElementWithSelectiveGenerator();//参数可用
